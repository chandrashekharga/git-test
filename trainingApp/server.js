...
app.get ('/api/resources/:rid', api.getResource); //error
app.put ('/api/resources/:rid', api.updateResource); //error
...
app.get ('/api/projects/:pid/resources/:id', api.getProjectResource); //error
...
app.put   ('/api/projects/:pid/backlogs/:bid/tasks/:tid/entries/:teid', api.updateTimeEntry);//error
app.delete('/api/projects/:pid/backlogs/:bid/tasks/:tid/entries/:teid', api.deleteTimeEntry);//error
// Missing task with resource and project services.
